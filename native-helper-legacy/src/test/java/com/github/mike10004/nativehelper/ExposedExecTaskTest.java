...
public class ExposedExecTaskTest {
    ...
    public void testOutputEcho_fromFile() throws Exception {
        ...
        String inputString = Base64.getEncoder().encodeToString(randomBytes);
    ...
    private String generateRandomString() {
        ...
        Random random = new Random();
        random.nextBytes(randomBytes);
        Base64.Encoder encoder = Base64.getMimeEncoder(80, System.lineSeparator().getBytes());
        String inputString = encoder.encodeToString(randomBytes);
