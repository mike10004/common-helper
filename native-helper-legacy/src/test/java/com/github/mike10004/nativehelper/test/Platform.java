...
import com.github.mike10004.nativehelper.test.Platforms.UnsupportedPlatformException;
...
public interface Platform {
     ...
     * @see #getSystemConfigDir(String, String...)
     */
     ...
     * @throws UnsupportedPlatformException
     * if this platfgorm is not supported
     * @see #getCommonProgramFilesDir(String, String...)
     */
     ...
     * @throws UnsupportedPlatformException
     * if this platfgorm is not supported
     * @see #getProgramDataDir(String, String...)
     */
     ...
     * @throws UnsupportedPlatformException
     * if this platfgorm is not supported
     * @see #getUserConfigDir(String, String...)
     */
